...
To take a proper look at the data, I loaded the original dataset as a CSV file and the necessary libraries. After loading the original data, I looked for any missing values or outliers

<br>

```{r show_table,  tidy=TRUE, results='asis',max.print = 10, tidy.opts=list(width.cutoff=60)}
